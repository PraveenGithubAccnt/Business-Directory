...
export default function LoginScreen() {
  return (
    <View style={{ flex: 1, backgroundColor: '#E6E6FA' }}>
      {/* Extend background color to notch area */}
      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <View style={{ flex: 1, justifyContent: 'space-evenly', alignItems: 'center'}}>
          ...
          <View>
          <TouchableOpacity style={{ backgroundColor: "#7851A9", paddingVertical: 12,
            paddingHorizontal: 50,borderRadius:60,elevation: 5, }}>
          <Text style={{ fontSize: 15,fontFamily:'roboto_medium',color: "#ffffff",}}>Let's SignUp</Text>
         </TouchableOpacity>
          </View>
        </View>
      </SafeAreaView>
